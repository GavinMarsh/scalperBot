...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="scalperBot" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.home.server.TelegramBot %CMD_LINE_ARGS%
